...
<p><em>👀 Senior Software Development Engineer in Test at <a href="https://www.dana.id/">DANA
...
const ray = {
  ...
  technologies: {
        web: ["TestCafe", "WebDriver.io", "Selenium"],
        mobile: ["Selenium", "Appium"],
        misc: ["TestRail", "JIRA", "VSCode", "XMind", "Notion", "Mindomo"]
  },
